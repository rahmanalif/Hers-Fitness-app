    ...
    final success = await _profileController.updateTrainerProfile(
      UpdateTrainerProfileRequest(
        ...
        bio: _bioController.text.trim().isNotEmpty
            ...
            : null,
        fitnessClasses: _teachClasses.isNotEmpty ? List.from(_teachClasses) : null,
      ...
      builder: (_) => SafeArea(
        child: Wrap(
          children: [
            ListTile(
              leading:
                  Icon(Icons.photo_library_outlined, color: AppColors.actionPrimary),
            ...
            ListTile(
              leading:
                  Icon(Icons.camera_alt_outlined, color: AppColors.actionPrimary),
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(Icons.my_location_rounded,
                                size: 18.sp, color: AppColors.actionPrimary),
                            SizedBox(width: 8.w),
                            AppText(
              ...
              child: Obx(() {
                ...
                return Container(
                  ...
                  child: imageUrl.isEmpty
                      ? Icon(Icons.person,
                          color: AppColors.textSecondary, size: 38.w)
                      : null,
                );
              }),
            ),
          ...
          Row(
            ...
            children: [
              ...
              AppText(
                '${_teachClasses.length}/10',
                style:
                    AppTextStyles.xs12Regular.copyWith(color: Colors.grey),
              ),
            ],
          ),
        ],
